				...
				<div class="col-lg col-md-6">
					<div class="ftco-footer-widget">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="fa fa-map-marker mr-3"></span><span class="text">Treichville Belleville près du supermarché bon prix villa lot 33

                                </span></li>
								<li><a href="#"><span class="fa fa-phone mr-3"></span><span class="text">Phone: +225 21 24 15 21</span></a></li>
                                <li><a href="#"><span class="fa fa-phone mr-3"></span><span class="text"> Fax: +225 21 24 15 25  </span></a></li>
								<li><a href="#"><span class="fa fa-paper-plane mr-3"></span><span class="text"> ets_dh@hotmail.com</span></a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6 aside-stretch py-3">
						...
						<p class="mb-0"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
							Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved  <i class="fa fa-heart" aria-hidden="true"></i> by <a href="#" target="_blank">Ets-DH</a>
