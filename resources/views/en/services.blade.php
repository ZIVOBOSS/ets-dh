    ...
    <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-start">
          ...
          <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Acceuil <i class="fa fa-chevron-right"></i></a></span> <span>Services <i class="fa fa-chevron-right"></i></span></p>
 ...
 <div class="container">
  <div class="row justify-content-center mb-5 pb-2">
    <div class="col-md-8 text-center heading-section ftco-animate">
     ...
     <h2 class="mb-4 ">Les Services Que Nous Offrons</h2>
   </div>
 </div>
   ...
   <div class="col-md-4">
    <div class="services-wrap ftco-animate">
     ...
     <div class="text">
      ...
      <h2>Travaux d’électricité HTA,</h2>
...
<div class="col-md-4">
  <div class="services-wrap ftco-animate">
   ...
   <div class="text">
    ...
    <h2>Travaux d’électricité  BTA ,</h2>
    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
    <a href="#" class="btn-custom">Read more</a>
  </div>
</div>
...
<div class="col-md-4">
  <div class="services-wrap ftco-animate">
   ...
   <div class="text">
    ...
    <h2>Travaux d’électricité EP ,</h2>
    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
    <a href="#" class="btn-custom">Read more</a>
  </div>
</div>
...
<div class="col-md-4">
  <div class="services-wrap ftco-animate">
   ...
   <div class="text">
    <div class="icon"><span class="flaticon-worker"></span></div>
    <h2>Location d’engin </h2>
    <p>Location d’engin de levage camion grue et nacelle,et nacelle,et nacelle,et nacelle,</p>
    <a href="#" class="btn-custom">Read more</a>
  </div>
</div>
</div>
<div class="col-md-4">
  <div class="services-wrap ftco-animate">
   ...
   <div class="text">
    ...
    <p>Vente de matériel &amp; électriques électriques électriques électriques électriques</p>
    <a href="#" class="btn-custom">Read more</a>
  </div>
</div>
</div>
