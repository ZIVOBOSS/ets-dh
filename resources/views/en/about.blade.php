		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-end justify-content-start">
				<div class="col-md-9 ftco-animate pb-5">
					<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Acceuil <i class="fa fa-chevron-right"></i></a></span> <span>Apropos <i class="fa fa-chevron-right"></i></span></p>
					<h1 class="mb-3 bread">Apropos</h1>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 d-flex align-items-stretch">
					<div class="about-wrap img w-100" style="background-image: url(/images/img1.jpg);">
				...
				<div class="col-md-6 py-5 pl-md-5">
					<div class="row justify-content-center mb-4 pt-md-4">
						<div class="col-md-12 heading-section ftco-animate">
							...
							<h2 class="mb-4">Etablissement Dabo her</h2>
							<div class="d-flex about">
								<div class="icon"><span class="flaticon-hammer"></span></div>
								<h4>Créée en 2012, ETS DH Sarl est une société spécialisée dans le domaine électrique et le génie civil. Evoluant dans un
                                    environnement de plus en plus compétitif et concurrentiel, notre principal défi est de répondre aux exigences croissantes de nos
                                    clients.</h4>
							</div>
							<p>


                                    Ainsi, notre vision est d’être parmi les meilleures entreprises de travaux d’électricité, tout en développant le génie civil à
                                    l’horizon 2025. Pour ce faire, ETS DH Sarl s’est engagé depuis 2019 dans une démarche qualité selon la norme ISO 9001 v 2015.
                                    Les axes majeurs devant nous conduire à la réalisation de cette ambition sont les suivants :
                                    • Signer des partenariats avec des fournisseurs et fabricants.
                                    • Assurer la gestion de la maintenance des équipements dans le but de garantir leur robustesse et leur performance.
                                    • S'inscrire dans une démarche d'amélioration continue pour une organisation performante.
                                    • Assurer le suivi et l'encadrement du personnel par la mise en place d’une gestion de plan carrière.
                                    • Garantir et maintenir un environnement de travail propice dans le but d’accroitre les performances et accroitre la
                                    rentabilité.
                                    • Assurer une veille technologique, légale et règlementaire.
                                    • La diversification des activités.
                                    Cette stratégie nécessitera des ressources indispensables pour fournir un cadre pour l’établissement et la consolidation de nos
                                    principaux objectifs qualités.
                                    {{-- que sont :
                                    ▪ Le respect des délais de réalisation de nos prestations.
                                    ▪ L’amélioration de la qualité de nos prestations.
                                    ▪ La maitrise des coûts et l’accroissement de la rentabilité. --}}
                                </p>
			...
			<div class="row justify-content-center">
				<div class="col-md-12 text-center">
					<div class="img"  style="background-image: url(/images/bg_2.jpg);">
						<div class="overlay"></div>
						<h2>Le respect des délais de réalisation de nos prestations.</h2>
						<p>L’amélioration de la qualité de nos prestations.</p>
                        <p>La maitrise des coûts et l’accroissement de la rentabilité.</p>
			...
			<div class="row no-gutters">
				<div class="col-md-6 py-5 bg-secondary aside-stretch">
					<div class="heading-section heading-section-white p-4 pl-md-0 py-md-5 pr-md-5">
						<span class="subheading">ETS DH</span>
						<h2 class="mb-4">Meilleur fournisseur de composant xxx  en cote d'Ivoire</h2>
						...
						<div class="flipper">
							...
							<div class="back">
								...
								<div class="author d-flex">
									...
									<div class="name align-self-center ml-3">Mr. Dabo <span class="position">CEO</span></div>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="row ftco-animate justify-content-center">
				<div class="col-md-6 p-4 pl-md-0 py-md-5 pr-md-5 aside-stretch d-flex align-items-center">
					<div class="heading-section heading-section-white">
						<span class="subheading" style="color:#fff;">Temoignages des clients</span>
						<h2 class="mb-4" style="font-size: 50px;">C'est toujours une joie d'entendre que le travail que nous faisons a des critiques positives</h2>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg col-md-6">
					<div class="ftco-footer-widget">
						<h2 class="ftco-heading-2 d-flex align-items-center">Apropos</h2>
						<p>Avec ETS-DH , l'excellence au service de sa clientel</p>
