  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-end justify-content-start">
      <div class="col-md-9 ftco-animate pb-5">
       <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Acceuil <i class="fa fa-chevron-right"></i></a></span> <span>Partenaires <i class="fa fa-chevron-right"></i></span></p>
       <h1 class="mb-3 bread">Nos partenaires</h1>
     </div>
   </div>
 </div>
</section>
...
<section class="ftco-section bg-light">
  <div class="container">
    <div class="row d-flex">
      <div class="col-lg-4 ftco-animate">
        <div class="blog-entry">
          <a href="blog-single.html" class="block-20" style="background-image: url('/images/cie1.png');">
          </a>
   ...
   <div class="col-lg-4 ftco-animate">
    <div class="blog-entry">
      <a href="blog-single.html" class="block-20" style="background-image: url('/images/sodeci.png');">
      </a>
      <div class="text d-block">
       <div class="meta">
        <p>
...
<div class="col-lg-4 ftco-animate">
  <div class="blog-entry">
    <a href="blog-single.html" class="block-20" style="background-image: url('/images/bouyges.png');">
    </a>
    <div class="text d-block">
     <div class="meta">
      <p>
...
<div class="col-lg-4 ftco-animate">
  <div class="blog-entry">
    <a href="blog-single.html" class="block-20" style="background-image: url('/images/ciener.png');">
    </a>
    <div class="text d-block">
     <div class="meta">
      <p>
...
<div class="col-lg-4 ftco-animate">
  <div class="blog-entry">
    <a href="blog-single.html" class="block-20" style="background-image: url('/images/ecobank.png');">
    </a>
    <div class="text d-block">
     <div class="meta">
      <p>
...
<div class="col-lg-4 ftco-animate">
  <div class="blog-entry">
    <a href="blog-single.html" class="block-20" style="background-image: url('/images/plasticable.jpeg');">
    </a>
    <div class="text d-block">
     <div class="meta">
      <p>
...
<div class="col-lg-4 ftco-animate">
    <div class="blog-entry">
      <a href="blog-single.html" class="block-20" style="background-image: url('/images/sotici.png');">
      </a>
      <div class="text d-block">
       <div class="meta">
        <p>
  ...
  <div class="col-lg-4 ftco-animate">
    <div class="blog-entry">
      <a href="blog-single.html" class="block-20" style="background-image: url('/images/sibm.jpeg');">
      </a>
      <div class="text d-block">
       <div class="meta">
        <p>
  ...
  <div class="col-lg-4 ftco-animate">
    <div class="blog-entry">
      <a href="blog-single.html" class="block-20" style="background-image: url('/images/depagne.png');">
      </a>
      <div class="text d-block">
       <div class="meta">
        <p>
  ...
  <div class="col-lg-4 ftco-animate">
    <div class="blog-entry">
      <a href="blog-single.html" class="block-20" style="background-image: url('/images/ensto.png');">
      </a>
      <div class="text d-block">
       <div class="meta">
        <p>
  ...
  <div class="col-lg-4 ftco-animate">
    <div class="blog-entry">
      <a href="blog-single.html" class="block-20" style="background-image: url('/images/cahors.png');">
      </a>
      <div class="text d-block">
       <div class="meta">
        <p>
  ...
  <div class="col-lg-4 ftco-animate">
    <div class="blog-entry">
      <a href="blog-single.html" class="block-20" style="background-image: url('/images/retis.png');">
      </a>
      <div class="text d-block">
       <div class="meta">
        <p>
