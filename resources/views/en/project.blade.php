		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-end justify-content-start">
				<div class="col-md-9 ftco-animate pb-5">
					<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Acceuil <i class="fa fa-chevron-right"></i></a></span> <span>Projets <i class="fa fa-chevron-right"></i></span></p>
		...
		<div class="container">
			<div class="row justify-content-center mb-5 pb-3">
				<div class="col-md-7 text-center heading-section ftco-animate">
					<span class="subheading">Nos realisations </span>
					<h2 class="mb-4">Projets recents</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4">
					<div class="project">
						...
						<div class="text">
							<span class="subheading">Genie civil</span>
							<h3>Construction BT</h3>
							<p><span class="fa fa-map-marker mr-1"></span> Sinemantiali, frommagée, CI</p>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="project">
						...
						<div class="text">
							<span class="subheading">Electricité</span>
							<h3>Haut tension</h3>
							<p><span class="fa fa-map-marker mr-1"></span> Sinemantiali, frommagée, CI</p>
						</div>
					</div>
